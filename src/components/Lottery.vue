...
<div>
    ...
    <button class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
...
export default{
    ...
    methods:{
        submitNumbersE(){
            this.$emit('submitEvent',this.selections);
        }
    }
